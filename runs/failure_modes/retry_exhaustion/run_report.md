# Runtime Demo Run 2026-05-06_240d1c56_retry_exhaustion

## Setup

- Task: Fetch a permanently-broken URL; bounded retry exhausts after max_retries.
...
- Retries: 3 (1 exhausted)
- Failure modes triggered: retry_exhaustion
- Result: failure (retry_exhaustion)
