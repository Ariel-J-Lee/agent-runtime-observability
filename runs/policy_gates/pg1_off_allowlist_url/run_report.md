# Runtime Demo Run 2026-05-06_240d1c56_pg1_off_allowlist_url

## Setup

- Task: Retrieve the operations summary from the off-allowlist host.
...
- Policy-gate trips:
- step 0: deny on rule_id `url_allowlist`
